...
$esg_stream_count_limit = Essential_Grid_Base::get_stream_count_limit();
						...
						<div id="external-stream-wrap">
							<div>
								...
								<div class="eg-cs-tbc ">
									...
									<div id="eg-source-vimeo-message"><label></label><span class="description"><?php esc_html_e('The "Vimeo Stream" content source is used to display a full stream of videos from a user/album/group/channel.', ESG_TEXTDOMAIN); ?></span></div>
								</div>
							</div>
						...
						<div id="youtube-external-stream-wrap">
							...
							<div>
								...
								<div class="eg-cs-tbc">
									...
									--><input type="number" value="<?php echo $base->getVar($grid, array('postparams', 'youtube-count'), '12'); ?>" name="youtube-count" class="stream-count"><div class="space18"></div><!--
									--><span class="description"><span class="material-icons material-icons-outlined">info</span><?php
										echo esc_html(sprintf(
											/* translators: %s: stream items count limit */
											__( 'Count is limited to %s items MAX!', ESG_TEXTDOMAIN ),
											$esg_stream_count_limit
										)); ?></span>
									<div class="div13"></div>
						...
						<div id="vimeo-external-stream-wrap">
							...
							<div>
								...
								<div class="eg-cs-tbc">
									...
									--><input type="number" value="<?php echo $base->getVar($grid, array('postparams', 'vimeo-count'), '12'); ?>" name="vimeo-count" class="stream-count"><div class="space18"></div><!--
									--><span class="description"><span class="material-icons material-icons-outlined">info</span><?php
										echo esc_html(sprintf(
										/* translators: %s: stream items count limit */
												__( 'Count is limited to %s items MAX!', ESG_TEXTDOMAIN ),
						...
						<div id="instagram-external-stream-wrap">
							...
							<div>
								...
								<div class="eg-cs-tbc">
									...
									--><input type="number" value="<?php echo $base->getVar($grid, array('postparams', 'instagram-count'), '12'); ?>" name="instagram-count" class="stream-count"><div class="space18"></div><!--
									--><span class="description"><span class="material-icons material-icons-outlined">info</span><?php
										echo esc_html(sprintf(
										/* translators: %s: stream items count limit */
												__( 'Count is limited to %s items MAX!', ESG_TEXTDOMAIN ),
						...
						<div id="flickr-external-stream-wrap">
							...
							<div>
								...
								<div class="eg-cs-tbc">
									...
									--><input type="number" value="<?php echo $base->getVar($grid, array('postparams', 'flickr-count'), '12'); ?>" name="flickr-count" class="stream-count"><div class="space18"></div><!--
									--><span class="description"><span class="material-icons material-icons-outlined">info</span><?php
										echo esc_html(sprintf(
										/* translators: %s: stream items count limit */
												__( 'Count is limited to %s items MAX!', ESG_TEXTDOMAIN ),
						...
						<div id="facebook-external-stream-wrap">
							...
							<div>
								...
								<div class="eg-cs-tbc">
									...
									<input type="number" value="<?php echo $base->getVar($grid, array('postparams', 'facebook-count'), '12'); ?>" name="facebook-count" class="stream-count"><div class="space18"></div><!--
									--><span class="description"><span class="material-icons material-icons-outlined">info</span><?php
										echo esc_html(sprintf(
										/* translators: %s: stream items count limit */
												__( 'Count is limited to %s items MAX!', ESG_TEXTDOMAIN ),
						...
						<div id="twitter-external-stream-wrap">
							...
							<div>
								...
								<div class="eg-cs-tbc">
									...
									--><input type="number" value="<?php echo $base->getVar($grid, array('postparams', 'twitter-count'), '12'); ?>" name="twitter-count" class="stream-count"><div class="space18"></div><!--
									--><span class="description"><span class="material-icons material-icons-outlined">info</span><?php
										echo esc_html(sprintf(
										/* translators: %s: stream items count limit */
												__( 'Count is limited to %s items MAX!', ESG_TEXTDOMAIN ),
...
If you are a current API user you will still be able to fetch the data though.', ESG_TEXTDOMAIN); ?></span>
							...
							<div>
								...
								<div class="eg-cs-tbc">
									<label class="eg-new-label eg-tooltip-wrap" title="<?php esc_attr_e('Stream this number of posts', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Count', ESG_TEXTDOMAIN); ?></label><!--
									--><input type="number" value="<?php echo $base->getVar($grid, array('postparams', 'behance-count'), '12'); ?>" name="behance-count" class="stream-count"><div class="space18"></div><!--
									--><span class="description"><span class="material-icons material-icons-outlined">info</span><?php
										echo esc_html(sprintf(
										/* translators: %s: stream items count limit */
												__( 'Count is limited to %s items MAX!', ESG_TEXTDOMAIN ),
...
<script type="text/javascript">
	...
	function esg_grid_create_ready_function() {
		...
		AdminEssentials.setStreamCountLimit(<?php echo $esg_stream_count_limit; ?>);

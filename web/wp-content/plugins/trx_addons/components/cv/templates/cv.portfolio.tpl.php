...
<div class="trx_addons_cv_section trx_addons_cv_section_portfolio<?php if ($trx_addons_cv_ajax_loader) echo ' trx_addons_cv_section_ajax'; ?>" data-section="<?php echo esc_attr(trx_addons_cpt_param('portfolio', 'post_type_slug')); ?>">
	...
	<div class="trx_addons_cv_section_content">
		...
		if (!empty($content)) {
			?>
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'trx_addons_cv_portfolio_page itemscope'); trx_addons_seo_snippets('', 'Article'); ?>>

				<?php do_action('trx_addons_action_before_article', 'cv.portfolio'); ?>
		...
		if (!empty($content)) {
				...
				<?php do_action('trx_addons_action_after_article', 'cv.portfolio'); ?>

            ...
            protected function register_controls() {
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'placeholder' => __( 'Title of the widget', 'trx_addons' ),
                        'default'     => '',
                    ]
                );
                ...
                $this->add_control(
                    'caption',
                    [
                        'label'       => __( 'Caption', 'trx_addons' ),
                        'label_block' => false,
                        'type'        => \Elementor\Controls_Manager::TEXT,
                        'placeholder' => __( 'Caption of the widget', 'trx_addons' ),
                        'default'     => '',
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'label_block' => false,
                        'type'        => \Elementor\Controls_Manager::TEXT,
                        'placeholder' => __( 'Name of the author', 'trx_addons' ),
                        'default'     => '',
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        'name'        => 'url',
                        'label'       => __( 'Audio URL', 'trx_addons' ),
                        'label_block' => false,
                        'type'        => \Elementor\Controls_Manager::TEXT,
                        'placeholder' => __( 'URL for audio file', 'trx_addons' ),
                        'default'     => [
                            'url' => '',
                            'is_external' => '',
                        ]
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'placeholder' => __( 'or paste HTML code to embed audio', 'trx_addons' ),
                        'default'     => [
                            'url' => '',
                            'is_external' => '',
                        ]

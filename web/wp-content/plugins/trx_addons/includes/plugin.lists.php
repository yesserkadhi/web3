...
if ( !function_exists( 'trx_addons_get_list_sc_aligns' ) ) {
	function trx_addons_get_list_sc_aligns($prepend_inherit=false, $add_none=true) {
		$list = array(
...
// For Elementor TRX Widgets --  Start
...
if ( !function_exists( 'trx_addons_get_list_sc_slider_paginations_types' ) ) {
    function trx_addons_get_list_sc_slider_paginations_types() {
        return apply_filters('trx_addons_filter_get_list_sc_slider_paginations_types', array(
            ...
            'progressbar' => esc_html__('Progress', 'trx_addons')
        ));
    }
}
...
// Additional attributes for VC and SOW and Elementor
//----------------------------------------------------
if ( !function_exists( 'trx_addons_get_list_sc_color_styles' ) ) {
    function trx_addons_get_list_sc_color_styles() {
        return apply_filters('trx_addons_filter_get_list_sc_color_styles', array(
            'default' => esc_html__('Default', 'trx_addons'),

...
.sidebar[class*="scheme_"] .widget:nth-child(4n+1):before {
    border-top-color: {$colors['text_link2']};
}
.sidebar[class*="scheme_"] .widget:nth-child(4n+2),
.sidebar[class*="scheme_"] .widget:nth-child(4n+2):before {
    border-top-color: {$colors['text_link']};
}
.sidebar[class*="scheme_"] .widget:nth-child(4n+3):before {
    border-top-color: {$colors['text_hover']};
}
.sidebar[class*="scheme_"] .widget:nth-child(4n+4):before {

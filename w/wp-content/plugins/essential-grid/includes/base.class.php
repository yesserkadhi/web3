...
class Essential_Grid_Base
{
	...
	protected static function get_javascript_multilanguage()
	{
		$lang = array(
			...
			/* ADDONS */
			'addon' => __('Add-On', ESG_TEXTDOMAIN),
			'installingaddon' => __('Installing Add-On', ESG_TEXTDOMAIN),
			'updatingaddon' => __('Updating Add-On', ESG_TEXTDOMAIN),
			'enableaddon' => esc_attr__('Enable Add-On', ESG_TEXTDOMAIN),
			'enablingaddon' => __('Enabling Add-On', ESG_TEXTDOMAIN),
			'disableaddon' => esc_attr__('Disable Add-On', ESG_TEXTDOMAIN),
			'disablingaddon' => __('Disabling Add-On', ESG_TEXTDOMAIN),
			'activateaddon' => __('Activate Add-On', ESG_TEXTDOMAIN),
			'activatingaddon' => __('Activating Add-On', ESG_TEXTDOMAIN),
			...
			'activateglobaladdon' => __('Activate Global Add-On', ESG_TEXTDOMAIN),
			'err_slug_missing' => __('Add-On slug is missing!', ESG_TEXTDOMAIN),
			/* SHORTCODE */
			'essential_grid_shortcode_creator' => __('Essential Grid Shortcode Creator', ESG_TEXTDOMAIN),
			'shortcode_generator' => __('Shortcode Creator', ESG_TEXTDOMAIN),
	...
	/**
	 * get default stream items limit 
	 * 
	 * @return int
	 */
	public static function get_stream_count_limit_default()
	{
		return 60;
	}
	
	/**
	 * get stream items limit 
	 * 
	 * @return int
	 */
	public static function get_stream_count_limit()
	{
		return get_option('tp_eg_stream_count_limit', self::get_stream_count_limit_default());
	}
}

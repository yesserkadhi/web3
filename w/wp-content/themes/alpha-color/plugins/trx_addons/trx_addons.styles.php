...
if (!function_exists('alpha_color_trx_addons_get_css')) {
	add_filter('alpha_color_filter_get_css', 'alpha_color_trx_addons_get_css', 10, 4);
	function alpha_color_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
/* Tabs */
.elementor-widget-container .trx_addons_tabs .trx_addons_tabs_titles li a,
.widget .trx_addons_tabs .trx_addons_tabs_titles li a {
	color: {$colors['alter_text']};
	background-color: {$colors['alter_bd_color']};
}

.elementor-widget-container .trx_addons_tabs .trx_addons_tabs_titles li.ui-state-active a,
.elementor-widget-container .trx_addons_tabs .trx_addons_tabs_titles li a:hover,
...
.elementor-element .contacts_info,
.widget_contacts .contacts_info {
	color: {$colors['alter_text']};
}
.elementor-element .contacts_info span:before,
.elementor-element .contacts_info a:before,
...
.elementor-element .contacts_info span a:hover,
.elementor-element .contacts_info a:hover,
...
.slider-wrapper .sc_blogger_item_content,
.sc_blogger_item {
	background-color: {$colors['alter_bg_color']};
}
